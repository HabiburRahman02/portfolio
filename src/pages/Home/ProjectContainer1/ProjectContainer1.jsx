...
const ProjectContainer1 = () => {
    return (
        <div className="grid md:grid-cols-2 gap-16 my-16">
            <Fade>
                <div className="p-6 md:p-8 space-y-4 shadow-2xl rounded-2xl bg-gray-100 border-2 border-t-gray-700 border-r-8 border-r-gray-700 border-b-8 border-b-gray-700 border-l-gray-700 hover:border-t-indigo-500 hover:border-r-pink-500 hover:border-b-pink-500 hover:border-l-indigo-500 transition-all">
                    <a href="https://touristsspot-1f4a5.web.app" target="_blank">
                        <Tilt>
                            <img className='w-full h-[230px] md:h-[270px] object-cover rounded-md' src={travelImg} alt="" />
                        </Tilt>
                    </a>
                    <p className="text-2xl text-fuchsia-600">Featured Project</p>
                    <p className="text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-pink-500">Tourists Spots Website</p>
                    <p className="hidden">It’s a tourist spots website with some great features. After entering the website, you'll first see a banner. Then you can view various spots, including their names, locations, and other details. If you want to add a new spot, you’ll need to log in to access all features. If you don't have an account yet, you will need to sign up first. Besides logging in, there are other features you’ll discover as you browse the website.</p>
                    <div className='flex items-center justify-between'>
                        ...
                        <a href="https://github.com/HabiburRahman02/tourist-spots-client" target="_blank">
                            <div className='text-5xl  hover:text-slate-900 text-black cursor-pointer'>
                                <FaGithub></FaGithub>
                            </div>
                        </a>
                    </div>
            ...
            <Fade>
                <div className="p-6 md:p-8 space-y-4 shadow-2xl rounded-2xl  bg-white border-2 border-t-gray-700 border-r-8 border-r-gray-700 border-b-8 border-b-gray-700 border-l-gray-700 hover:border-t-indigo-500 hover:border-r-pink-500 hover:border-b-pink-500 hover:border-l-indigo-500 transition-all">
                    <a href="https://product-store-3197e.web.app" target="_blank">
                        <Tilt>
                            <img className='w-full h-[230px] md:h-[270px] object-cover rounded-md' src={productStoreImg} alt="" />
                        </Tilt>

                    </a>
                    <p className="text-2xl text-fuchsia-600">Featured Project</p>
                    <p className="text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-pink-500">Product Store Website</p>
