...
const Contact = () => {
    return (
        <Fade >
            <div className="my-16">
                <h1 className="text-5xl dark:text-white font-bold  text-center text-indigo-500 text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-pink-500"> Contact_ </h1>
                            ...
                            <div className="md:w-3/5">
                                <form className="card-body rounded-2xl border-2 border-t-gray-700 border-r-8 border-r-gray-700 border-b-8 border-b-gray-700 border-l-gray-700 hover:border-t-indigo-500 hover:border-r-pink-500 hover:border-b-pink-500 hover:border-l-indigo-500 transition-all">
                                    ...
                                    <div className="form-control mt-6">
                                        <button className=" p-6 text-white rounded-sm bg-gradient-to-r from-indigo-500 to-pink-500">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
